...
![Version: 3.11.0-bb.0](https://img.shields.io/badge/Version-3.11.0--bb.0-informational?style=flat-square) ![AppVersion: v3.11.0](https://img.shields.io/badge/AppVersion-v3.11.0-informational?style=flat-square)
...
| postUpgrade.labelNamespace.image.tag | string | `"v1.26.1"` |  |
...
| postInstall.labelNamespace.image.tag | string | `"v1.26.1"` |  |
...
| preUninstall.deleteWebhookConfigurations.image.tag | string | `"v1.26.1"` |  |
...
| image.crdRelease | string | `"v1.26.1"` |  |
