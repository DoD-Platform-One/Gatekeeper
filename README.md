...
![Version: 3.13.0-bb.2](https://img.shields.io/badge/Version-3.13.0--bb.2-informational?style=flat-square) ![AppVersion: v3.12.0](https://img.shields.io/badge/AppVersion-v3.12.0-informational?style=flat-square)
...
| postUpgrade.labelNamespace.image.tag | string | `"1.27.6"` |  |
...
| postInstall.labelNamespace.image.tag | string | `"1.27.6"` |  |
...
| preUninstall.deleteWebhookConfigurations.image.tag | string | `"1.27.6"` |  |
