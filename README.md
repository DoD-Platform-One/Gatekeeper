...
| postUpgrade.labelNamespace.image.tag | string | `"v1.25.6"` |  |
...
| postInstall.labelNamespace.image.tag | string | `"v1.25.6"` |  |
...
| preUninstall.deleteWebhookConfigurations.image.tag | string | `"v1.25.6"` |  |
...
| image.crdRelease | string | `"v1.25.6"` |  |
