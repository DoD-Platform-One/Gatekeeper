...
| validatingWebhookSubResources[0] | string | `"pods/ephemeralcontainers"` |  |
| validatingWebhookSubResources[1] | string | `"pods/exec"` |  |
| validatingWebhookSubResources[2] | string | `"pods/log"` |  |
| validatingWebhookSubResources[3] | string | `"pods/eviction"` |  |
| validatingWebhookSubResources[4] | string | `"pods/portforward"` |  |
| validatingWebhookSubResources[5] | string | `"pods/proxy"` |  |
| validatingWebhookSubResources[6] | string | `"pods/attach"` |  |
| validatingWebhookSubResources[7] | string | `"pods/binding"` |  |
| validatingWebhookSubResources[8] | string | `"pods/resize"` |  |
| validatingWebhookSubResources[9] | string | `"deployments/scale"` |  |
| validatingWebhookSubResources[10] | string | `"replicasets/scale"` |  |
| validatingWebhookSubResources[11] | string | `"statefulsets/scale"` |  |
| validatingWebhookSubResources[12] | string | `"replicationcontrollers/scale"` |  |
| validatingWebhookSubResources[13] | string | `"services/proxy"` |  |
| validatingWebhookSubResources[14] | string | `"nodes/proxy"` |  |
| validatingWebhookSubResources[15] | string | `"services/status"` |  |
| validatingWebhookURL | string | `nil` |  |
| validatingWebhookScope | string | `"*"` |  |
...
| mutatingWebhookSubResources[0] | string | `"pods/ephemeralcontainers"` |  |
| mutatingWebhookSubResources[1] | string | `"pods/exec"` |  |
| mutatingWebhookSubResources[2] | string | `"pods/log"` |  |
| mutatingWebhookSubResources[3] | string | `"pods/eviction"` |  |
| mutatingWebhookSubResources[4] | string | `"pods/portforward"` |  |
| mutatingWebhookSubResources[5] | string | `"pods/proxy"` |  |
| mutatingWebhookSubResources[6] | string | `"pods/attach"` |  |
| mutatingWebhookSubResources[7] | string | `"pods/binding"` |  |
| mutatingWebhookSubResources[8] | string | `"deployments/scale"` |  |
| mutatingWebhookSubResources[9] | string | `"replicasets/scale"` |  |
| mutatingWebhookSubResources[10] | string | `"statefulsets/scale"` |  |
| mutatingWebhookSubResources[11] | string | `"replicationcontrollers/scale"` |  |
| mutatingWebhookSubResources[12] | string | `"services/proxy"` |  |
| mutatingWebhookSubResources[13] | string | `"nodes/proxy"` |  |
| mutatingWebhookSubResources[14] | string | `"services/status"` |  |
| mutatingWebhookURL | string | `nil` |  |
| mutatingWebhookScope | string | `"*"` |  |
...
| postUpgrade.labelNamespace.image.tag | string | `"v1.32.8"` |  |
...
| postInstall.labelNamespace.image.tag | string | `"v1.32.8"` |  |
...
| preUninstall.deleteWebhookConfigurations.image.tag | string | `"v1.32.8"` |  |
...
| controllerManager.disableWebhookOperation | bool | `false` |  |
| controllerManager.disableGenerateOperation | bool | `true` |  |
| exportBackend | string | `""` |  |
| audit.exportConnection.path | string | `"/tmp/violations/topics"` |  |
| audit.exportConnection.maxAuditResults | int | `3` |  |
| audit.exportVolumeMount.path | string | `"/tmp/violations"` |  |
| audit.exportVolume.name | string | `"tmp-violations"` |  |
| audit.exportVolume.emptyDir | object | `{}` |  |
| audit.exportSidecar.name | string | `"reader"` |  |
| audit.exportSidecar.image | string | `"ghcr.io/open-policy-agent/fake-reader:latest"` |  |
| audit.exportSidecar.imagePullPolicy | string | `"Always"` |  |
| audit.exportSidecar.securityContext.allowPrivilegeEscalation | bool | `false` |  |
| audit.exportSidecar.securityContext.capabilities.drop[0] | string | `"ALL"` |  |
| audit.exportSidecar.securityContext.readOnlyRootFilesystem | bool | `true` |  |
| audit.exportSidecar.securityContext.runAsGroup | int | `999` |  |
| audit.exportSidecar.securityContext.runAsNonRoot | bool | `true` |  |
| audit.exportSidecar.securityContext.runAsUser | int | `1000` |  |
| audit.exportSidecar.securityContext.seccompProfile.type | string | `"RuntimeDefault"` |  |
| audit.exportSidecar.volumeMounts[0].mountPath | string | `"/tmp/violations"` |  |
| audit.exportSidecar.volumeMounts[0].name | string | `"tmp-violations"` |  |
| audit.serviceAccount.name | string | `"gatekeeper-admin"` |  |
| audit.enablePubsub | bool | `false` |  |
| audit.containerName | string | `"manager"` |  |
...
| audit.disableGenerateOperation | bool | `false` |  |
| audit.disableAuditOperation | bool | `false` |  |
| audit.disableStatusOperation | bool | `false` |  |
