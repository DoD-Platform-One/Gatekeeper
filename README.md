...
![Version: 3.9.0-bb.1](https://img.shields.io/badge/Version-3.9.0--bb.1-informational?style=flat-square) ![AppVersion: v3.9.0](https://img.shields.io/badge/AppVersion-v3.9.0-informational?style=flat-square)
...
| postUpgrade.labelNamespace.image.tag | string | `"v1.22.2"` |  |
...
| preUninstall.deleteWebhookConfigurations.image.tag | string | `"v1.22.2"` |  |
