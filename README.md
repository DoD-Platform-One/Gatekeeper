...
![Version: 3.12.0-bb.3](https://img.shields.io/badge/Version-3.12.0--bb.3-informational?style=flat-square) ![AppVersion: v3.12.0](https://img.shields.io/badge/AppVersion-v3.12.0-informational?style=flat-square)
...
| postUpgrade.labelNamespace.image.tag | string | `"v1.26.4"` |  |
...
| postInstall.labelNamespace.image.tag | string | `"v1.26.4"` |  |
...
| preUninstall.deleteWebhookConfigurations.image.tag | string | `"v1.26.4"` |  |
