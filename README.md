...
![Version: 3.16.3-bb.0](https://img.shields.io/badge/Version-3.16.3--bb.0-informational?style=flat-square) ![AppVersion: v3.16.3](https://img.shields.io/badge/AppVersion-v3.16.3-informational?style=flat-square)
...
| postUpgrade.labelNamespace.image.tag | string | `"v1.29.5"` |  |
...
| postInstall.labelNamespace.image.tag | string | `"v1.29.5"` |  |
...
| preUninstall.deleteWebhookConfigurations.image.tag | string | `"v1.29.5"` |  |
...
| bbtests.scripts.image | string | `"registry1.dso.mil/ironbank/opensource/kubernetes/kubectl:v1.29.5"` |  |
