...
![Version: 3.14.0-bb.4](https://img.shields.io/badge/Version-3.14.0--bb.4-informational?style=flat-square) ![AppVersion: v3.14.0](https://img.shields.io/badge/AppVersion-v3.14.0-informational?style=flat-square)
...
| postUpgrade.labelNamespace.image.tag | string | `"v1.28.5"` |  |
...
| postInstall.labelNamespace.image.tag | string | `"v1.28.5"` |  |
...
| preUninstall.deleteWebhookConfigurations.image.tag | string | `"v1.28.5"` |  |
