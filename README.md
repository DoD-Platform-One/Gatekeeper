...
![Version: 3.12.0-bb.4](https://img.shields.io/badge/Version-3.12.0--bb.4-informational?style=flat-square) ![AppVersion: v3.12.0](https://img.shields.io/badge/AppVersion-v3.12.0-informational?style=flat-square)
...
| enableGeneratorResourceExpansion | bool | `false` |  |
...
| postUpgrade.labelNamespace.image.tag | string | `"1.27.3"` |  |
...
| postInstall.labelNamespace.image.tag | string | `"1.27.3"` |  |
...
| preUninstall.deleteWebhookConfigurations.image.tag | string | `"1.27.3"` |  |
...
| bbtests.scripts.image | string | `"registry1.dso.mil/ironbank/opensource/kubernetes/kubectl:1.27.3"` |  |
