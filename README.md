...
![Version: 3.16.0-bb.0](https://img.shields.io/badge/Version-3.16.0--bb.0-informational?style=flat-square) ![AppVersion: v3.16.0](https://img.shields.io/badge/AppVersion-v3.16.0-informational?style=flat-square)
...
| postUpgrade.labelNamespace.image.tag | string | `"v1.29.4"` |  |
...
| postInstall.labelNamespace.image.tag | string | `"v1.29.4"` |  |
...
| preUninstall.deleteWebhookConfigurations.image.tag | string | `"v1.29.4"` |  |
